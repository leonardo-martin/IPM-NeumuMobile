...
import AppointmentTabItemScreen from '@pages/admin/appointments/extra/appointment-tabItem'
...
const AppointmentsRoutes: FC = (): ReactElement => {
    ...
    return (
        <TopTab.Navigator initialRouteName='Ativos' tabBar={(props: MaterialTopTabBarProps) => <AppointmentsTabBar {...props} />} >
